public class OddEvenPrinterStatic {
    private static int max;
    private static int number = 1;  // Starting number
    private static final Object lock = new Object(); // Shared lock for synchronization

    public OddEvenPrinterStatic(int max) {
        this.max = max;
    }
    ...
    public static void main(String[] args) {
     ...
     //   OddEvenPrinter printer = new OddEvenPrinter(maxNumber);
        ...
        Thread t1 = new Thread(()-> printOdd(), "T1");
        Thread t2 = new Thread(()->printEven(), "T2");
